<template>
    <div>
        <div class="mb-3">
            <h4>Need help with your account activation?</h4>
            <p>Enter your email, and we’ll help you activate your account.</p>
        </div>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <button class="btn btn-success btn-block" @click.prevent="resendActivationLink($event)">
                            Submit
                        </button>
                    </div>
    ...
    resendActivationLink(e) {
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          ...
          axios
            .post(APIURL + "account/resendactivationlink", params)
            .then(response => {
              ...
              if (res.status == 200) {
                ...
                if (res.status == 403) {
                  ...
                  $(".resetMsg").html(
                    '<p class="text-danger text-center s-v-e" id="resetMsg">' +
                      res.msg +
                      "</p>"
                  );
