    ...
    <div class="container my-5">
      <div class="row" v-if="orderCartItems.length > 0">
        ...
        <div class="col-md-8 cart-card px-3 py-4">
          <shopping-cart-item
            v-for="(cartItem, i) in orderCartItems"
            :key="cartItem.mask"
            :cartItem="cartItem"
            :arrIndex="i"
              ...
              <div class="ml-md-auto">
                <div class="cart-btn">
                  <span class="btn-link-danger">
                    <button class="btn btn-default" @click="emptyCart($event)">Empty Cart</button>
                  </span>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <div
            class="card"
            style="background-color: #fff; box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.2);"
          >
            <div class="card-body">
          ...
          <div class="my-5 card">
            <div class="card-body py-5">
              <div class="text-center">
                ...
                <div class="mt-4">
                  <router-link to="/products" class="btn btn-success px-5">Shop Now</router-link>
                </div>
              </div>
            </div>
          </div>
